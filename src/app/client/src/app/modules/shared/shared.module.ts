...
import {
  ...
  OnDemandReportsComponent, DesktopAppUpdateComponent, SystemWarningComponent, AlertModalComponent, FullPageLoaderComponent, ModalWrapperComponent, ModalContentDirective, SlickComponent, TelemetryErrorModalComponent
} from './components';
import {
...
@NgModule({
  ...
  declarations: [AppLoaderComponent, DateFormatPipe,
    ...
    AutocompletePipe, MaterialAutoCompleteComponent, TransposeTermsPipe, SlickComponent, TranslateJsonPipe, TelemetryErrorModalComponent
  ],
  exports: [AppLoaderComponent, DateFormatPipe, TranslateModule,
    ...
    AutocompletePipe, MaterialAutoCompleteComponent, MaterialModule, TransposeTermsPipe, SlickComponent, TranslateJsonPipe, TelemetryErrorModalComponent
  ]
})
